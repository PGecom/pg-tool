...
//Import logo Images
import logosmdark from "../../assets/images/pg-logo.png";
import logodark from "../../assets/images/pg-logo.png";
import logosmlight from "../../assets/images/pg-logo.png";
import logolight from "../../assets/images/pg-logo.png";
                    ...
                    <div className="d-flex">
                        ...
                        <div className="navbar-brand-box">
                            ...
                            <Link to="#" className="logo logo-light">
                                <span className="logo-sm">
                                    <img src={logosmlight} alt="" height="100"/>
                                </span>
                                <span className="logo-lg">
