                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted">Get your free PG-ecom Tool.</p>
                                            </div>
                                            ...
                                            <div className="p-2 mt-5">
                                                <AvForm onValidSubmit={this.handleSubmit} className="form-horizontal" >
                                                    ...
                                                    <div className="mt-4 text-center">
                                                        <p className="mb-0">By registering you agree to the PG-ecom Tool <Link to="#" className="text-primary">Terms of Use</Link></p>
                                                    </div>
                                                </AvForm>
                                            </div>
